...
using Lykke.Service.RealEstateBonusAgent;
using Lykke.Service.RealEstateBonusAgent.Client;
using Microsoft.AspNetCore.Mvc;
using Refit;
using Xunit;

namespace Lykke.Service.RealEstateBonusAgent.Tests
{
    public class ClientHttpPathsAreMatchedInControllersTest
    {
        ...
        {
            var clientInterface = typeof(IRealEstateBonusAgentClient);
