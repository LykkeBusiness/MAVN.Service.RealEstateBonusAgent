...
namespace Lykke.Service.RealEstateBonusAgent.DomainServices.Subscribers
{
    public abstract class RabbitSubscriber<TMessage> : IStartStop
    {
        ...
        public async Task StartProcessingAsync(TMessage message)
        {
            ...
            if (!string.IsNullOrEmpty(result.errorMessage))
                Log.Warning($"{_contextName} process message", result.errorMessage);
